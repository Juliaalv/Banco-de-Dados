...
'''                    Código desenvolvido com objetivo de criar uma  de conexão entre um simulador de Modbus TCP/IP 
                                            e um banco de dados - Júlia Alves Santos             '''
...
def data_entry():
    ...
    dados = [m.read_holding_registers(101,1),m.read_holding_registers(102,1),
